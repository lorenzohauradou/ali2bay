      ...
      >
        <motion.div variants={itemVariants} className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-600">
            <span className="font-semibold text-gray-600">Risparmia tempo</span> e <span className="font-semibold text-gray-600">vendi</span> di più. <span className="font-semibold text-gray-600">Collega il tuo account eBay</span> e <span className="font-semibold text-gray-600">pubblica prodotti</span> da <span className="font-semibold text-gray-600">Amazon</span> e <span className="font-semibold text-gray-600">AliExpress</span>  in un solo click:
